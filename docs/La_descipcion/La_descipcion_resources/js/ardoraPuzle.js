...
imaSel=-1;$("#ardoraActCanvas").attr("role","img");$("#ardoraActCanvas").attr("aria-label","La descripción");$(".imaCell_img img").each(function(e){$(this).attr("alt",$(this).parent().parent().attr("id"));});$(".imaCell_img img").attr("tabindex","0");
